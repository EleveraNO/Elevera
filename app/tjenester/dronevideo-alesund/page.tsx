        ...
        <div className="relative z-10 mx-auto max-w-4xl text-center">
          ...
          <div className="mb-8 flex flex-col items-center">
            <svg width="140" height="100" viewBox="0 0 140 100" fill="none" xmlns="http://www.w3.org/2000/svg">
              {/* Shadow */}
              <ellipse className="drone-shadow" cx="70" cy="95" rx="30" ry="5" fill="#2DD4BF" />

              <g className="drone-body">
                {/* Arms */}
                <line x1="70" y1="48" x2="28" y2="28" stroke="#2DD4BF" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="70" y1="48" x2="112" y2="28" stroke="#2DD4BF" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="70" y1="56" x2="28" y2="72" stroke="#2DD4BF" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="70" y1="56" x2="112" y2="72" stroke="#2DD4BF" strokeWidth="2.5" strokeLinecap="round" />

                {/* Body */}
                <rect x="57" y="42" width="26" height="20" rx="5" fill="#2DD4BF" fillOpacity="0.15" stroke="#2DD4BF" strokeWidth="1.5" />
                <rect x="63" y="48" width="14" height="8" rx="2" fill="#2DD4BF" fillOpacity="0.35" />

                {/* Camera */}
                <circle cx="70" cy="65" r="4" fill="#2DD4BF" fillOpacity="0.5" stroke="#2DD4BF" strokeWidth="1" />
                <circle cx="70" cy="65" r="2" fill="#2DD4BF" />

                {/* LED blink */}
                <circle cx="70" cy="48" r="2" fill="#2DD4BF" fillOpacity="0.9" />

                {/* Propeller hubs + spinning blades */}
                {/* Top-left */}
                <circle cx="28" cy="28" r="5" fill="#0a0a0a" stroke="#2DD4BF" strokeWidth="1.5" />
                <g className="prop-tl">
                  <rect x="13" y="25.5" width="30" height="5" rx="2.5" fill="#2DD4BF" fillOpacity="0.6" />
                  <rect x="25.5" y="13" width="5" height="30" rx="2.5" fill="#2DD4BF" fillOpacity="0.6" />
                </g>

                {/* Top-right */}
                <circle cx="112" cy="28" r="5" fill="#0a0a0a" stroke="#2DD4BF" strokeWidth="1.5" />
                <g className="prop-tr">
                  <rect x="97" y="25.5" width="30" height="5" rx="2.5" fill="#2DD4BF" fillOpacity="0.6" />
                  <rect x="109.5" y="13" width="5" height="30" rx="2.5" fill="#2DD4BF" fillOpacity="0.6" />
                </g>

                {/* Bottom-left */}
                <circle cx="28" cy="72" r="5" fill="#0a0a0a" stroke="#2DD4BF" strokeWidth="1.5" />
                <g className="prop-bl">
                  <rect x="13" y="69.5" width="30" height="5" rx="2.5" fill="#2DD4BF" fillOpacity="0.6" />
                  <rect x="25.5" y="57" width="5" height="30" rx="2.5" fill="#2DD4BF" fillOpacity="0.6" />
                </g>

                {/* Bottom-right */}
                <circle cx="112" cy="72" r="5" fill="#0a0a0a" stroke="#2DD4BF" strokeWidth="1.5" />
                <g className="prop-br">
                  <rect x="97" y="69.5" width="30" height="5" rx="2.5" fill="#2DD4BF" fillOpacity="0.6" />
                  <rect x="109.5" y="57" width="5" height="30" rx="2.5" fill="#2DD4BF" fillOpacity="0.6" />
                </g>
              </g>
            </svg>
          </div>
          ...
          <div className="mb-6 inline-flex items-center gap-2 rounded-full border px-4 py-1.5" style={{ borderColor: "rgba(45,212,191,0.2)", background: "rgba(45,212,191,0.06)" }}>
            ...
            <span className="text-sm font-medium" style={{ color: "rgba(45,212,191,0.8)" }}>Ålesund og Sunnmøre</span>
          </div>
          <h1 className="mb-6 text-4xl font-bold leading-tight text-white sm:text-5xl md:text-6xl">
            Profesjonell{" "}
            <em style={{ fontFamily: "var(--font-fraunces), Georgia, serif", fontStyle: "italic", color: "#2DD4BF" }}>dronevideo</em>{" "}
            i Ålesund
          </h1>
