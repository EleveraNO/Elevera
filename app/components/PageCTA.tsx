      ...
      <div className="mx-auto max-w-3xl text-center">
        ...
        >
          ...
          <div
            ...
            style={{ border: "1px solid rgba(45,212,191,0.2)", background: "rgba(45,212,191,0.07)" }}
          >
          ...
          <div className="mb-8 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              ...
              style={{ background: TEAL, color: "#09090B" }}
            >
              Book gratis møte
            </a>
            <a
              ...
              style={{ borderColor: "rgba(255,255,255,0.15)", color: "rgba(242,237,230,0.7)" }}
            >
          ...
          <div className="mb-8 flex items-center gap-4">
            ...
            <span className="text-sm" style={{ color: "rgba(242,237,230,0.3)" }}>Eller send oss en melding</span>
            <div className="h-px flex-1" style={{ background: "rgba(255,255,255,0.08)" }} />
          </div>
